...
object TrainView {
    ...
    fun displayCoach(coachName: CoachName,noOfCompartments: Int,totalSeatsInCoach: Int,availableSeatsInCoach: Int,farePerStation:Double){
        ...
        println("Fare Per Station: $farePerStation")
    }
